...
function showReviews() {
    ...
    for (var i = 0; i < allReviews.length; i++) {
        ...
        html += "<div class='review-item'><strong>" + allReviews[i].name + " — " + allReviews[i].city + "</strong><br><span class='review-stars'>" + stars + "</span><p class='review-comment'>" + allReviews[i].comment + "</p></div>";    }
